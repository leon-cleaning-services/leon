...
val KuaishouSanitizer =
    Sanitizer(
        id = SanitizerId("kuaishou"),
        name = "Kuaishou",
        rules = persistentListOf(Rule.RemoveParameters("share|userId|photoId")),
        match =
            persistentListOf(
                Match(HostMatch.Domain("kuaishou.com")),
                Match(HostMatch.Domain("v.kuaishou.com")),
            ),
    )
