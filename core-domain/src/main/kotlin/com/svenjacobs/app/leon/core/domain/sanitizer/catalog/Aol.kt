...
val AolSearchSanitizer =
    Sanitizer(
        id = SanitizerId("aol_search"),
        name = "AOL Search",
        // The redirect target is embedded in the path, not in a query parameter: .../RU=<url>/...
        rules =
            persistentListOf(
                Rule.Follow(
                    Source.Path,
        ...
        match = persistentListOf(Match(HostMatch.Domain("search.aol.com"))),
    )
