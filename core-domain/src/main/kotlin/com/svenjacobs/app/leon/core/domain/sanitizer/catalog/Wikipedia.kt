...
val WikipediaSanitizer =
    Sanitizer(
        id = SanitizerId("wikipedia"),
        name = "Wikipedia",
        rules = persistentListOf(Rule.RemoveParameters("wprov")),
        match = persistentListOf(Match(HostMatch.Subdomains("wikipedia.org"))),
    )
