...
val Weibo =
    Sanitizer(
        id = SanitizerId("weibo"),
        name = "Weibo",
        rules = persistentListOf(Rule.RemoveParameters("from|refer|share_token")),
        match =
            persistentListOf(
                Match(HostMatch.Domain("weibo.com")),
                Match(HostMatch.Domain("m.weibo.cn")),
            ),
    )
