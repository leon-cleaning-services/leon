...
val DingtalkSanitizer =
    Sanitizer(
        id = SanitizerId("dingtalk"),
        name = "DingTalk",
        rules = persistentListOf(Rule.RemoveParameters("from|scene|channel|source|refer")),
        match =
            persistentListOf(
                Match(HostMatch.Subdomains("dingtalk.com")),
                Match(HostMatch.Subdomains("dingtalk.cn")),
            ),
    )
