...
val ElFinancieroSanitizer =
    Sanitizer(
        id = SanitizerId("elfinanciero"),
        name = "ElFinanciero",
        rules = persistentListOf(Rule.RemoveParameters("outputType")),
        match = persistentListOf(Match(HostMatch.Domain("elfinanciero.com.mx"))),
    )
