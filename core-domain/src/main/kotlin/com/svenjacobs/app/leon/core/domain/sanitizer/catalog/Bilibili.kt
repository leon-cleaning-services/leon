...
val BilibiliSanitizer =
    Sanitizer(
        id = SanitizerId("bilibili"),
        name = "Bilibili",
        rules =
            persistentListOf(Rule.RemoveParameters("vd_source|seid|from|share_source|copy_link")),
        match = persistentListOf(Match(HostMatch.Domain("bilibili.com"))),
    )
