...
val IlMessaggeroSanitizer =
    Sanitizer(
        id = SanitizerId("ilmessaggero"),
        name = "Il Messaggero",
        rules = persistentListOf(Rule.RemoveParameters("topic", negate = true)),
        match = persistentListOf(Match(HostMatch.Domain("archivio.ilmessaggero.it"))),
    )
