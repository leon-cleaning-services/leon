...
val LinkedInSanitizer =
    Sanitizer(
        id = SanitizerId("linkedin"),
        name = "LinkedIn",
        rules = persistentListOf(Rule.RemoveParameters("rcm")),
        match = persistentListOf(Match(HostMatch.Domain("linkedin.com"))),
    )
