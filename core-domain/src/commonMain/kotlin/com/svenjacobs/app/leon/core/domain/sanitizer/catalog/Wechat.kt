...
val Wechat =
    Sanitizer(
        id = SanitizerId("wechat"),
        name = "WeChat",
        rules = persistentListOf(Rule.RemoveParameters("__biz|mid|idx|sn|scene|wx_header")),
        match =
            persistentListOf(
                Match(HostMatch.Domain("weixin.qq.com")),
                Match(HostMatch.Domain("url.cn")),
            ),
    )
