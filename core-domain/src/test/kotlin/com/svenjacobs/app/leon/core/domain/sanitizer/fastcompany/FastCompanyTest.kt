...
import com.svenjacobs.app.leon.core.domain.sanitizer.catalog.FastCompany
import io.kotest.matchers.shouldBe

class FastCompanyTest :
    SanitizerSpec(
        FastCompany,
        {
            "clean" should
                    ...
                    "clean fastcompany.com URLs" {
                        clean(
                            "https://www.fastcompany.com/90890683/bronx-dream-school-david-adjaye?u" +
                                ...
                                "20Newsletter%20-%20FC%20-%20Top%2010%205-7-23&leadld=77345" +
            ...
            "matches" should
                {
                    "match fastcompany.com" { matches("https://fastcompany.com") shouldBe true }
                }
        },
    )
