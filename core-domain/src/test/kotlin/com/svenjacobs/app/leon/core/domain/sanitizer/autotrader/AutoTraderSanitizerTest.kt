...
import com.svenjacobs.app.leon.core.domain.sanitizer.catalog.AutoTraderSanitizer
            ...
            "matches" should
                {
                    "match AutoTrader car details URL" {
                        matches("https://www.autotrader.co.uk/car-details/202602280303309") shouldBe
                            true
                    }
                }
        },
