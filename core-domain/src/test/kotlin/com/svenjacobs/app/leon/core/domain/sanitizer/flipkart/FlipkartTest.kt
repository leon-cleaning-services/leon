...
class FlipkartTest :
    SanitizerSpec(
        Flipkart,
        {
            ...
            "matches" should
                {
                    "match *.flipkart.com" { matches("https://aa.flipkart.com") shouldBe true }

                    "match flipkart.com without subdomain" {
                        matches("https://flipkart.com") shouldBe true
                    }

                    "not match flipkart.com inside another URL" {
                        matches("https://evil.com/?u=aa.flipkart.com") shouldBe false
                    }

                    "not match host which only starts with flipkart.com" {
                        matches("https://aa.flipkart.com.evil.com") shouldBe false
                    }
                }
        },
    )
