...
import com.svenjacobs.app.leon.shared.resources.screen_history
import com.svenjacobs.app.leon.shared.resources.screen_main
import com.svenjacobs.app.leon.shared.resources.screen_settings
...
sealed interface Destination : NavKey {
    ...
    data object Main : TopLevel {
        ...
        override val label = Res.string.screen_main
        override val iconContentDescription = Res.string.screen_main
    }

    @Serializable
    data object History : TopLevel {
        override val icon = Icons.Filled.History
        override val label = Res.string.screen_history
        override val iconContentDescription = Res.string.screen_history
    }

    @Serializable
    data object Settings : TopLevel {
        override val icon = Icons.Filled.Settings
        override val label = Res.string.screen_settings
        override val iconContentDescription = Res.string.screen_settings
    }
