...
import com.svenjacobs.app.leon.shared.resources.a11y_back_navigation
import com.svenjacobs.app.leon.shared.resources.scaffold_title
...
private fun NavigationIcon(modifier: Modifier = Modifier, onClick: () -> Unit) {
    IconButton(modifier = modifier, onClick = onClick) {
        Icon(
            ...
            contentDescription = stringResource(Res.string.a11y_back_navigation),
        )
    }
}
